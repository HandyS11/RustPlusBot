...
/// <summary>Resolves the per-server #map channel (game-to-Discord direction only).</summary>
public interface IMapChannelLocator
{
    /// <summary>Gets the Discord channel id of the #map for (<paramref name="guildId"/>, <paramref name="serverId"/>), or null.</summary>
