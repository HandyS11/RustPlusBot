...
/// <summary>Dictionary-backed <see cref="ICommandLocalizer"/> with English fallback and region normalization.</summary>
/// <remarks>Duplicated from <c>Workspace.Localizer</c>; consolidate into a shared project in a future refactor.</remarks>
