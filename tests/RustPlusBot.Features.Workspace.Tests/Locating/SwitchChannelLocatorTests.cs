...
{
    private static (SwitchChannelLocator Locator, ServiceProvider Provider, string ConnectionString, IClock Clock)
        CreateLocator()
    {
    ...
    private static async Task<Guid> SeedAsync(string connectionString)
    {
        ...
        context.ProvisionedChannels.Add(new ProvisionedChannel
        {
            ...
            ChannelKey = WorkspaceChannelKeys.ServerSwitches,
    ...
    [Fact]
    public async Task GetChannelIdAsync_returns_provisioned_switches_channel()
    {
